...
from pure_pursuit_carrot.include.pure_pursuit_carrot import (
    PurePursuitCarrotController
)


class PurePursuitCarrotNode(DTROS):

    def __init__(self, node_name):

        # Initialize the DTROS parent class
        super(PurePursuitCarrotNode, self).__init__(
        ...
        self.controller = PurePursuitCarrotController(self.params)
...
if __name__ == "__main__":
    # Initialize the node
    pure_pursuit_controller_node = PurePursuitCarrotNode(
        node_name="pure_pursuit_carrot_node"
    )
    # Keep it spinning
    rospy.spin()
